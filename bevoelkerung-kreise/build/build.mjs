...
// Der Versatz der beleuchteten Kante, in Bildpunkten, und wie kräftig ihre
// beiden Sicheln sind. Siehe scheibenMalen.
let KANTENVERSATZ = 1.1, KANTENHELL = 0.85, KANTENDUNKEL = 0.75;
...
function scheibenMalen(s) {
  ...
  for (let k = 0; k < N; k++) {
    ...
    if (k > 0) {
      ...
      const lv = (KANTENVERSATZ / zz) * Math.SQRT1_2;
      ctx.translate(-lv, -lv);
