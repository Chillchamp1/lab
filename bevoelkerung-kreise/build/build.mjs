...
const WANDDUNKEL = 0.80;            // so viel bleibt von der Bandfarbe stehen
...
function scheibenMalen(s) {
  ...
  for (let k = 0; k < N; k++) {
    ...
    if (k > 0) {
      ctx.setTransform(a2, b2, c2, d2, eX, D * (ozY - (k - 1) * dz) - b2 * cx - d2 * cy);
      ctx.fillStyle = WANDFARBE[Math.min(WANDFARBE.length - 1, k)];
