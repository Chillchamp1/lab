...
- **[Europa unter dem Eis](https://chillchamp1.github.io/lab/eiszeit-europa/)** — Eine animierte Reliefkarte Europas durch die letzte Eiszeit: echtes Gebirgsrelief aus einem 15-Bogensekunden-Höhenmodell, darunter die Kruste, die unter dem Eis einsinkt und danach wieder steigt, darüber der skandinavische Eisschild und das veröffentlichte Unsicherheitsband seines Randes. Die Verarbeitungskette steht und ist geprüft — die Seite wartet noch auf die drei Datensätze und zeigt bis dahin, woraus sie gebaut wird, statt erfundenes Gelände. In English. · [Doku](eiszeit-europa/README.md)
