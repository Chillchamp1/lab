...
- **[Deutschland, gezeichnet von seinen Fahrplänen](https://chillchamp1.github.io/lab/bahn-zeitkarte/)** — 4.781 Bahnhöfe des Fern- und Regionalverkehrs, nicht nach Kilometern gezeichnet, sondern nach der Reisezeit mit dem Zug: zwischen je zwei Bahnhöfen hängt eine Feder mit der Reisezeit als Ruhelänge, und die Karte ist die Lage, in der alle Federn zusammen am wenigsten ziehen — ein Kilometer Luftlinie ist dabei 1,14 Minuten wert. Die Höhe darüber ist die gemessene Erreichbarkeit, die mittlere Reisezeit von hier zu allem anderen, und ein Regler hebt das Wasser darüber: dann liegt das ICE-Kreuz Frankfurt–Fulda–Kassel–Erfurt–Würzburg als Binnenmeer unter Wasser und Sylt, Rügen und der Zipfel um Konstanz steigen als Gebirge daraus auf. Fahrplan ist ein Mittwoch aus dem offenen DELFI-Datensatz, Abfahrt in der dichtesten Stunde des Tages — die gemessen wurde und 06:36 bis 07:36 liegt. · [Doku](bahn-zeitkarte/README.md)
