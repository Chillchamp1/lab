...
function zeichne() {
  ...
  // Die Trennlinie zwischen den Ländern hat die Farbe dessen, was hinter der
  // Karte liegt — auf dem Blatt das Papier, auf der Kugel das Meer. Sonst
  // bekäme jede Küste auf dem Globus einen hellen Saum in Papierfarbe.
  ctx.lineJoin = 'round';
  ctx.strokeStyle = hex(misch(PAPIER_RGB, MEER_RGB, meer));
